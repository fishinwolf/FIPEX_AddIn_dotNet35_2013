...
Public Class Analysis
    ...
    Protected Sub RunAnalysis()
        ...
        For i = 0 To pOriginaljuncFlagsList.Count - 1
            ...
            If bDBF = True Then
                ...
                Dim bUndirected As Boolean = True '= Convert.ToBoolean(m_FiPEx__1.pPropset.GetProperty("bUndirected"))
    ...
    Private Sub UpdateSummaryTable(ByRef lRefinedHabStatsList As List(Of StatisticsObject_2), _
                                   ...
                                   ByRef pResultsForm3 As FiPEX_AddIn_dotNet35_2.frmResults_3, _
